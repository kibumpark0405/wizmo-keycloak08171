<template>
    <div style="max-height:80vh;">
        <div style="position: absolute; top:15px; left:25px;">
            <div style="opacity:0.7; display: inline-block;">수주 &nbsp; ></div>
            <div style="display: inline-block;">&nbsp; 수주</div>
        </div>
        ...
        <wj-flex-grid
            ...
            class="wj-felx-grid"
        >
            <wj-flex-grid-filter :filterColumns="['RowHeader','salesOrderNumber','salesPerson','','companyId','salesItem',]" />
            ...
            <wj-flex-grid-column binding="" header="수주유형" width="2*" :isReadOnly="true" align="center" />
